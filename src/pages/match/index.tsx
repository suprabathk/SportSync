        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-sky-700 text-white p-6 text-left align-middle shadow-xl transition-all dark:bg-stone-950">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="flex justify-between items-center mt-1 mb-3 gap-6 ">
                    ...
                    {match?.isRunning ? (
                      <div className="flex items-center gap-1">
                        ...
                        <p className="text-white text-sm">Live now</p>
                      </div>
                    ) : (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {match?.playingTeam === match?.teams[0].id && (
                          <span className="bg-white rounded-full px-2 text-sky-700 gap-1 text-xs py-1 flex items-center">
                            <span className="p-1 rounded-full bg-sky-700"></span>
                            <span>Playing</span>
                          </span>
                        )}
                      </div>
